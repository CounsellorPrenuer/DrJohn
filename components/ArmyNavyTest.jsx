...
// ─── MAIN APP ─────────────────────────────────────────────────────────────────
export default function ArmyNavyTest() {
      ...
      <div style={{maxWidth:540,width:"100%"}}>
        <div style={{background:"#fff",borderRadius:20,padding:28,boxShadow:"0 4px 24px rgba(0,0,0,0.07)",marginBottom:16}}>
          <div style={{textAlign:"center",marginBottom:24}}>
            ...
            <h1 style={{fontSize:26,fontWeight:800,color:"#1E293B",margin:"0 0 6px"}}>ARMY NAVY AIR FORCE SELF ASSESSMENT</h1>
      ...
      <div style={{...BG,padding:"16px"}} ref={reportRef}>
        ...
        <div style={{maxWidth:680,margin:"0 auto"}}>
          ...
          <div className="fadein print-page" style={{background:"linear-gradient(135deg,#6C63FF,#4338CA)",borderRadius:20,padding:24,marginBottom:14,color:"#fff",textAlign:"center"}}>
            ...
            <h1 style={{fontSize:24,fontWeight:800,margin:"0 0 4px"}}>Your ARMY NAVY AIR FORCE SELF ASSESSMENT Report</h1>
          ...
          <div className="no-print" style={{textAlign:"center",paddingBottom:40}}>
            ...
            <p style={{color:"#94A3B8",fontSize:11,marginTop:12}}>© OverSimplify.in — ARMY NAVY AIR FORCE SELF ASSESSMENT · Powered by Claude AI</p>
          </div>
        </div>
      </div>
    );
